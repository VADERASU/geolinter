...
import {Card, Alert, Button, Divider, Row, Col, Image, Select, InputNumber, Radio, Input} from 'antd';
import arrow from "../../resource/arrow.png";
import { UpCircleTwoTone, DownCircleTwoTone } from '@ant-design/icons';

class NewCaseErr extends Component {
    constructor(props){
        super(props);
        this.state = {
    ...
    handleFix = () => {
        ...
        this.props.onMapProjChange("albers");
            ...
            return(
                ...
                >
                    ...
                    <Row gutter={[8,8]}>
                        ...
                        <Col span={24}><b style={{color: "red"}}>3. Map projection needs to be changed.</b> Based on the geographic extent of the map, we recommend you using a proper projection.</Col>
                        <Col span={24}>
                            <Row>
                                <Col span={1}>
                                    <Image
                                ...
                                <Col span={23}>
                                    <Row gutter={[5,5]}>
                                        <Col span={24}>
                                            ...
                                            ><b>Fix step 3: </b>The map will use: <b>Albers equal-area</b> projection </span>
                                        </Col>
                                    </Row>
                                </Col>
                            </Row>
                        ...
                        <Col span={24}><b style={{color: "red"}}>4. Missing data units.</b> Enter proper units for the map data.</Col>
                        <Col span={24}>
                            <Row>
                                <Col span={1}>
                                    <Image
                                ...
                                <Col span={23}>
                                    <Row gutter={[5,5]}>
                                        <Col span={24}>
                                            ...
                                            ><b>Fix step 4: </b>Enter the data units: </span>
                                            <Input size="small" 
                                            style={{
                                                float: 'left',
                                                width: 225
                                            }}
                                            placeholder="e.g. per catipa, or percent (%)" />
                                        </Col>
                                    </Row>
                                </Col>
                            </Row>
